...
author: Eduardo Junior - PET Estatística UFPR 
output: 
...
library(shiny)
## library(shinyGlobe)
## shinyAppDir("apps/shinyGlobe/")
shinyAppDir(system.file("examples/01_hello", package="shiny"))
```

<!-- <iframe scrolling="no" frameborder="0" height="400" width="100%" src="http://shiny.leg.ufpr.br/eduardo/meetup/"></iframe> -->
